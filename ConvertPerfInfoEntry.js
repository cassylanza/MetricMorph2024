...
const ConvertPerfInfoEntry = () => {
  ...
  const [desiredRaceVar, setDesiredRaceVar] = useState('');
    ...
    return (
      ...
      <View>
        ...
        <View style = {styles.container}>
          ...
          <TextInput style = {styles.input}
            placeholder = " Projected Race Distance (in meters)"
            keyboardType = 'number-pad'
            placeholderTextColor = "grey"
            onChangeText = {newDesRace => setDesiredRaceVar(newDesRace)}
            maxLength = {15}/>
...
export default ConvertPerfInfoEntry
