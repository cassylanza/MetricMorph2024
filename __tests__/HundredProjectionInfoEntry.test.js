...
import HundredProjectionInfoEntry from '../HundredProjectionInfoEntry';
...
describe('HundredProjectionInfoEntry', () => {
  it('renders correctly', () => {
    const tree = renderer.create(<HundredProjectionInfoEntry />).toJSON();
    expect(tree).toMatchSnapshot();
  });

  it('task bar swim button appears', () => {
    const { getByText } = render(<HundredProjectionInfoEntry />);
  ...
  test('text box appears', () => {
    const { getByTestId } = render(<HundredProjectionInfoEntry />);
